  ...
  return (
    <>
      <Comp
        ...
        {...props}
      >
        {/* Refraction layer — captures background WITHOUT blur,
            SVG filter bends/distorts it like real liquid glass */}
        <div
        ...
        {/* Inset shadow edges — glass rim highlights */}
        <div className="absolute inset-0 z-[1] rounded-full pointer-events-none
            shadow-[inset_0_1px_1px_rgba(255,255,255,0.35),inset_0_-1px_1px_rgba(0,0,0,0.15),inset_2px_2px_4px_rgba(255,255,255,0.12),inset_-2px_-2px_4px_rgba(0,0,0,0.08),0_0_12px_rgba(255,255,255,0.08)]
            dark:shadow-[inset_0_1px_1px_rgba(255,255,255,0.2),inset_0_-1px_1px_rgba(0,0,0,0.3),inset_2px_2px_4px_rgba(255,255,255,0.06),inset_-2px_-2px_4px_rgba(0,0,0,0.15),0_0_12px_rgba(0,0,0,0.2)]" />

        {/* Top specular highlight — the bright curve at the top of glass */}
        <div className="absolute inset-x-4 top-[2px] z-[2] h-[40%] rounded-full bg-gradient-to-b from-white/15 to-transparent pointer-events-none" />

        {/* Subtle background tint */}
        <div className="absolute inset-0 z-[1] rounded-full bg-white/5 dark:bg-white/[0.03] pointer-events-none" />
 ...
 * NO blur — keeps the background sharp but BENT.
 * The displacement creates visible light-bending through the glass.
 */
  ...
  return (
    <svg className="hidden" aria-hidden="true" style={{ position: 'absolute', width: 0, height: 0 }}>
      <defs>
        ...
        >
          {/* Organic noise — low frequency = large flowing curves like thick glass */}
          <feTurbulence
            type="fractalNoise"
          ...
          {/* Smooth the noise for natural glass-like curves */}
          <feGaussianBlur in="noise" stdDeviation="6" result="smoothNoise" />

          {/* Displace pixels — this IS the light bending/refraction */}
          <feDisplacementMap
            in="SourceGraphic"
            in2="smoothNoise"
            scale="45"
          ...
          {/* No final blur — liquid glass is sharp, not frosted */}
        </filter>
      </defs>
    </svg>
  );
